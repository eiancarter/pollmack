...
export const addCandidate = candidate => {
    return dispatch => {
        ...
        axios
            .post(`http://localhost:5600/api/candidates`, candidate)
            .then(res => {
...
export const deleteCandidate = candidate => {
    return dispatch => {
        ...
        axios
            .delete(`http://localhost:5600/api/candidates/${candidate.id}`)
...
export const updateCandidate = candidate => {
    return dispatch => {
        ...
        axios
            .put(`http://localhost:5600/api/candidates/${candidate.id}`, candidate)
